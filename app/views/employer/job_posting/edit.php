        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6 bg-gray-100">
                <div class="max-w-full mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                    <form action="<?php echo site_url('employer/job_posting/edit'); ?>" method="POST" class="p-8 space-y-8">
                        <?php csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="job_title" id="job_title" required class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2" value="<?php echo htmlspecialchars($job['job_title']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="location" id="location" required class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2" value="<?php echo htmlspecialchars($job['location']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="salary_range" id="salary_range" class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2" value="<?php echo htmlspecialchars($job['salary_range']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" name="application_deadline" id="application_deadline" required class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2" value="<?php echo $job['application_deadline']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" name="start_date" id="start_date" class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2" value="<?php echo $job['start_date']; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="job_description" id="job_description" rows="6" required class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2"><?php echo htmlspecialchars($job['job_description']); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="requirements" id="requirements" rows="6" class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2"><?php echo htmlspecialchars($job['requirements']); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="benefits" id="benefits" rows="4" class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2"><?php echo htmlspecialchars($job['benefits']); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="required_skills" id="required_skills" rows="4" class="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-primary focus:border-primary text-lg py-2"><?php echo htmlspecialchars($job['required_skills']); ?></textarea>
                                </div>
                            </div>
                        </div>
